 ...
 * @since October 2005
 */
public class AddBoundaryKeybCommand implements Command, Cloneable {
    
    private Interface parent;
    private Controller controller;
    private DrawingArea da;
	private StringTokenizer stk;
	private AddBoundaryMouseCommand cmd;
    
//*****************************************************************************
	
    /** Constructor method. */
    public AddBoundaryKeybCommand(JFrame parent) {
		...
		cmd = (AddBoundaryMouseCommand) this.parent.getSectionView().getDrawingArea().getClickedCommand();
    }
