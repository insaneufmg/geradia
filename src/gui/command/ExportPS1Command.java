 ...
 */
public class ExportPS1Command implements Command {
...
//*****************************************************************************
    ...
    public void execute() {
		...
		try {
			...
			Doc doc = new SimpleDoc(parent.getSectionView().getDrawingArea(), flavor, null);
