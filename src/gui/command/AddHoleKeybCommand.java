 ...
 * @since October 2005
 */
public class AddHoleKeybCommand implements Command, Cloneable {
    
    private Interface parent;
    private Controller controller;
    private DrawingArea da;
	private StringTokenizer stk;
	private AddHoleMouseCommand cmd;
    
//*****************************************************************************
	
    /** Constructor method. */
    public AddHoleKeybCommand(JFrame parent) {
		...
		cmd = (AddHoleMouseCommand) this.parent.getSectionView().getDrawingArea().getClickedCommand();
    }
