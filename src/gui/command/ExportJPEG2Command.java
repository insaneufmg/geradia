 ...
 */
public class ExportJPEG2Command implements Command {
...
//*****************************************************************************
    ...
    /**
     * Creates new ExportJPEG2Command
     * and sets the FileFilter of FileChooser.
     *
     * @param parent The JFrame parent.
     */
    public ExportJPEG2Command(JFrame parent) {
...
//*****************************************************************************
    ...
    public void execute() {
		...
		try{
			...
			writer.write(parent.getDiagramView().getDrawingArea().getImage());
