 ...
 * @since October 2005
 */
public class AddBoundaryMouseCommand implements Command, Cloneable {
...
//*****************************************************************************
    ...
    /** Constructor method. */
    public AddBoundaryMouseCommand(JFrame parent) {
...
//*****************************************************************************
    ...
    public void execute() {
        ...
        if (ini == null){
			...
			gp.moveTo((float)po.getX(), (float)po.getY());
            ...
            if (po.getX()!=ini.getX() || po.getY()!=ini.getY()) {
				...
				((SectionController)controller).getModel().getGModel().setBoundary(gp);
				controller.compose();
				ini = fin;
				PreviewLineCommand pl = new PreviewLineCommand(parent);
				pl.setInitialPoint(da.getViewPoint(ini));
...
//*****************************************************************************
    ...
    public Object clone() {
        try {
            AddBoundaryMouseCommand cmd = (AddBoundaryMouseCommand)super.clone();
			return cmd;
